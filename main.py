...
class FirstFrame(Frame):
    ...
    def __init__(self, master=None):
        ...
        '''建造时创建组件'''
        # 初始化组件的属性
        self.label_tit = Label(self, text='计科成绩管理系统', width=30, height=1, fg='blue', font=('黑体', 25))
        self.btn_stu = Button(self, text='查询', width=18, height=1, bg='gray', font=('黑体', 15))
        self.btn_adm = Button(self, text='成绩管理', width=18, height=1, bg='gray', font=('黑体', 15))
...
class RegisterFrame(Frame):
    ...
    def btn_cfm_ev(self, event):
        ...
        if self.type == '管理系统登录' and [self.adm.get(), self.pwd.get()] in Admin:  # 当在管理员登陆界面并且账号密码在管理员列表中
        ...
        elif self.type == '查询系统登录' and self.pwd.get() == '':
...
class StudentSet(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.label_M_grade = Label(self, text='M语言学分:', width=12, height=1, fg='black', font=('黑体', 15))
        self.label_E_grade = Label(self, text='易语言学分:', width=12, height=1, fg='black', font=('黑体', 15))
...
class AddStudent(Frame):
    def __init__(self, master=None):
        ...
        self.label_Mgrade = Label(self, text='M语言成绩:', width=12, height=1, fg='black', font=('黑体', 15))
        self.label_Egrade = Label(self, text='易语言成绩:', width=12, height=1, fg='black', font=('黑体', 15))
